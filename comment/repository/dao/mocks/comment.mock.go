...
func (m *MockCommentDAO) FindCommentList(ctx context.Context, comment dao.Comment) ([]dao.Comment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindCommentList", ctx, comment)
	ret0, _ := ret[0].([]dao.Comment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCommentDAOMockRecorder) FindCommentList(ctx, comment interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindCommentList", reflect.TypeOf((*MockCommentDAO)(nil).FindCommentList), ctx, comment)
}
...
func (mr *MockCommentDAOMockRecorder) FindOneByIDs(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCommentDAOMockRecorder) FindRepliesByPid(ctx, pid, offset, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCommentDAOMockRecorder) FindRepliesByRid(ctx, rid, id, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

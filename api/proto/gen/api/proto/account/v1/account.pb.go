...
const file_api_proto_account_v1_account_proto_rawDesc = "" +
	"\n" +
	"\"api/proto/account/v1/account.proto\x12\n" +
	"account.v1\"f\n" +
	...
	"\x06Credit\x12\x19.account.v1.CreditRequest\x1a\x1a.account.v1.CreditResponseB\x9a\x01\n" +
	"\x0ecom.account.v1B\fAccountProtoP\x01Z1ecodepub/pkg/model/api/proto/account/v1;accountv1\xa2\x02\x03AXX\xaa\x02\n" +
	"Account.V1\xca\x02\n" +
...
var (
	...
	file_api_proto_account_v1_account_proto_rawDescData []byte
)

func file_api_proto_account_v1_account_proto_rawDescGZIP() []byte {
	file_api_proto_account_v1_account_proto_rawDescOnce.Do(func() {
		file_api_proto_account_v1_account_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_proto_account_v1_account_proto_rawDesc), len(file_api_proto_account_v1_account_proto_rawDesc)))
	})
...
func file_api_proto_account_v1_account_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_proto_account_v1_account_proto_rawDesc), len(file_api_proto_account_v1_account_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,

...
const file_api_proto_payment_v1_payment_proto_rawDesc = "" +
	"\n" +
	"\"api/proto/payment/v1/payment.proto\x12\x06pmt.v1\":\n" +
	"\x06Amount\x12\x14\n" +
	...
	"\x06status\x18\x02 \x01(\x0e2\x15.pmt.v1.PaymentStatusR\x06status*\x8c\x01\n" +
	...
	"\n" +
	"GetPayment\x12\x19.pmt.v1.GetPaymentRequest\x1a\x1a.pmt.v1.GetPaymentResponseB\x82\x01\n" +
	"\n" +
	"com.pmt.v1B\fPaymentProtoP\x01Z-ecodepub/pkg/model/api/proto/payment/v1;pmtv1\xa2\x02\x03PXX\xaa\x02\x06Pmt.V1\xca\x02\x06Pmt\\V1\xe2\x02\x12Pmt\\V1\\GPBMetadata\xea\x02\aPmt::V1b\x06proto3"

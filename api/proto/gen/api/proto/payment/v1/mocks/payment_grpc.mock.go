...
//
//	mockgen -source=Webook/api/proto/gen/api/proto/payment/v1/payment_grpc.pb.go -package=pmtmocks -destination=Webook/api/proto/gen/api/proto/payment/v1/mocks/payment_grpc.mock.go
//

...
type FollowServiceClient interface {
	...
	//  获取默认的关注数
	GetFollowStatics(ctx context.Context, in *GetFollowStaticRequest, opts ...grpc.CallOption) (*GetFollowStaticResponse, error)
}
...
func (c *followServiceClient) GetFollowStatics(ctx context.Context, in *GetFollowStaticRequest, opts ...grpc.CallOption) (*GetFollowStaticResponse, error) {
...
type FollowServiceServer interface {
	...
	//  获取默认的关注数
	GetFollowStatics(context.Context, *GetFollowStaticRequest) (*GetFollowStaticResponse, error)
...
func (UnimplementedFollowServiceServer) GetFollowStatics(context.Context, *GetFollowStaticRequest) (*GetFollowStaticResponse, error) {
...
func _FollowService_GetFollowStatics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FollowServiceServer).GetFollowStatics(ctx, req.(*GetFollowStaticRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FollowService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/follow/v1/follow.proto",
}

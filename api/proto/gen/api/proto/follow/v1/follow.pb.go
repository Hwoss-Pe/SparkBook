...
const file_api_proto_follow_v1_follow_proto_rawDesc = "" +
	"\n" +
	" api/proto/follow/v1/follow.proto\x12\tfollow.v1\"X\n" +
	...
	"\tfollowees\x18\x02 \x01(\x03R\tfollowees\"G\n" +
	...
	"\x10follow_relations\x18\x01 \x03(\v2\x19.follow.v1.FollowRelationR\x0ffollowRelations\"^\n" +
	...
	"\x0ffollow_relation\x18\x01 \x01(\v2\x19.follow.v1.FollowRelationR\x0efollowRelation\"4\n" +
	"\x16GetFollowStaticRequest\x12\x1a\n" +
	"\bfollowee\x18\x01 \x01(\x03R\bfollowee\"V\n" +
	"\x17GetFollowStaticResponse\x12;\n" +
	"\ffollowStatic\x18\x01 \x01(\v2\x17.follow.v1.FollowStaticR\ffollowStatic2\xe1\x03\n" +
	"\rFollowService\x12=\n" +
	...
	"\vGetFollower\x12\x1d.follow.v1.GetFollowerRequest\x1a\x1e.follow.v1.GetFollowerResponse\x12Y\n" +
	"\x10GetFollowStatics\x12!.follow.v1.GetFollowStaticRequest\x1a\".follow.v1.GetFollowStaticResponseB\x92\x01\n" +
	"\rcom.follow.v1B\vFollowProtoP\x01Z/ecodepub/pkg/model/api/proto/follow/v1;followv1\xa2\x02\x03FXX\xaa\x02\tFollow.V1\xca\x02\tFollow\\V1\xe2\x02\x15Follow\\V1\\GPBMetadata\xea\x02\n" +
	"Follow::V1b\x06proto3"

var (
	file_api_proto_follow_v1_follow_proto_rawDescOnce sync.Once
	file_api_proto_follow_v1_follow_proto_rawDescData []byte
)

func file_api_proto_follow_v1_follow_proto_rawDescGZIP() []byte {
	file_api_proto_follow_v1_follow_proto_rawDescOnce.Do(func() {
		file_api_proto_follow_v1_follow_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_proto_follow_v1_follow_proto_rawDesc), len(file_api_proto_follow_v1_follow_proto_rawDesc)))
	})
...
func file_api_proto_follow_v1_follow_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_proto_follow_v1_follow_proto_rawDesc), len(file_api_proto_follow_v1_follow_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   1,

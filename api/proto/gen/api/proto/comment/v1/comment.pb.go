...
const file_api_proto_comment_v1_comment_proto_rawDesc = "" +
	"\n" +
	"\"api/proto/comment/v1/comment.proto\x12\n" +
	"comment.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc5\x02\n" +
	"\aComment\x12\x0e\n" +
	...
	"\x05utime\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\x05utime\"i\n" +
	...
	"\areplies\x18\x01 \x03(\v2\x13.comment.v1.CommentR\areplies2\xe8\x02\n" +
	...
	"\x0eGetMoreReplies\x12!.comment.v1.GetMoreRepliesRequest\x1a\".comment.v1.GetMoreRepliesResponseB\x9a\x01\n" +
	"\x0ecom.comment.v1B\fCommentProtoP\x01Z1ecodepub/pkg/model/api/proto/comment/v1;commentv1\xa2\x02\x03CXX\xaa\x02\n" +
	"Comment.V1\xca\x02\n" +
...
var (
	...
	file_api_proto_comment_v1_comment_proto_rawDescData []byte
)

func file_api_proto_comment_v1_comment_proto_rawDescGZIP() []byte {
	file_api_proto_comment_v1_comment_proto_rawDescOnce.Do(func() {
		file_api_proto_comment_v1_comment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_proto_comment_v1_comment_proto_rawDesc), len(file_api_proto_comment_v1_comment_proto_rawDesc)))
	})
...
func file_api_proto_comment_v1_comment_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_proto_comment_v1_comment_proto_rawDesc), len(file_api_proto_comment_v1_comment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
